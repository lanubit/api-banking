...
import { BAD_REQUEST_MESSAGE, BAD_REQUEST_STATUS } from '../../domain/util/constant/exception.constant';
    ...
    return await new Promise((resolve, reject) => {
      this.httpService.get(uri, { params })
        .subscribe((response) => {
            ...
            reject(new BadRequestException(BAD_REQUEST_MESSAGE, BAD_REQUEST_STATUS, {
